    ...
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-[var(--color-bg-primary)]">
        <div className="w-full max-w-md">
          ...
          {/* Demo credentials */}
          <div className="bg-[var(--color-bg-tertiary)] border border-[var(--color-border)] rounded-xl p-4 mb-6">
            <p className="text-xs text-[var(--color-text-muted)] mb-2">Credenciales de demo:</p>
            <div className="flex gap-4 text-sm">
              <div>
                <span className="text-[var(--color-text-muted)]">Admin:</span>
                <span className="text-[var(--color-primary)] ml-1">admin / admin123</span>
              </div>
              <div>
                <span className="text-[var(--color-text-muted)]">Cajero:</span>
                <span className="text-[var(--color-primary)] ml-1">cajero / cajero123</span>
              </div>
            </div>
          </div>
